...
-(void)didTap : (UIGestureRecognizer *)gesture {
    ...
    if(!isCollapsed) {
        CGFloat height = (CGFloat)(_items.count > 5 ? _itemHeight*7 : _itemHeight * (double)(_items.count));
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = AMLocalizedString(_items[indexPath.row],_items[indexPath.row]);
...
//        checkmark.image=[UIImage imageNamed:@"check_mark"];
//        checkmark.tintColor=[UIColor colorWithRed:223.0/255.0 green:60.0/255.0 blue:63.0/255.0 alpha:1];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    label.text=@"";
    label.text = AMLocalizedString(_items[SelectedIndex], _items[SelectedIndex]);
