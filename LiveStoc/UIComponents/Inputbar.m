...
-(void)addRightButton
{
    ...
    self.rightButton.frame = CGRectMake(size.width - size.height-10, 0, size.height-10, size.height-10);
...
//    [self.rightButton setTitle:@"Done" forState:UIControlStateNormal];
    [self.rightButton setBackgroundImage:[UIImage imageNamed:@"send"] forState:UIControlStateNormal];
...
-(void)addLeftButton
{
    ...
    self.leftButton.frame = CGRectMake(0, 0, size.height-10, size.height-10);
...
-(void)setLeftButtonImage:(UIImage *)leftButtonImage
{
    ...
    self.leftButton.layer.cornerRadius=(self.leftButton.frame.size.width-10)/2;
